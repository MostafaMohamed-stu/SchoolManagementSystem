...
namespace SchoolManagementSystem.Controllers
{
    ...
    public class SubjectController : ControllerBase
    {
        ...
        private readonly ITeacherRepo _studentRepo;

        public SubjectController(ITeacherRepo studentRepo, ISubjectRepo subjectRepo)
        {
        ...
        public async Task<IActionResult> GetSubjects([FromQuery] int? minStudents)
        {
            ...
            var result = subjects
                .Select(s => new
                {
                    ...
                    s.Description,
                    Students = students
                        .Where(st => st.Classes.Min(ss => ss.TeacherId == s.Id))
        ...
        public async Task<IActionResult> GetSubject(int id)
        {
            ...
            var students = (await _studentRepo.GetAll())
                .Where(s => s.Classes.Any(ss => ss.TeacherId == id))
        ...
        public async Task<IActionResult> DeleteSubject(int id)
        {
            ...
            if (subject.StudentSubjects.Any())
                return NotFound("Cannot delete subject: students are enrolled");
